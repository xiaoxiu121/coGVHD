...
# do
#   echo $i
#   mv /data/caolili/oGVHD_model/output_model_2task_0923_full/finetune-full-base-2024*-bysy-5211-r$i /data/caolili/oGVHD_model/output_model_2task_0923_full/finetune-full-base-20241001-bysy-5211-r$i
# done
...
output_dir=/data/caolili/oGVHD_model/output_model_2task_0923_full/finetune-full-base-20241001-bysy-5211-r$i

cd /data/caolili/oGVHD_model/eval_med_2task_0923
