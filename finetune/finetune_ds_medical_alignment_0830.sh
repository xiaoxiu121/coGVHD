...
DATA='/public/mmllm/caolili/bysy_all/bysy_exetern_data/alignment_all_0909.json' # 新的预测模型，用于测试

cur_time=$(date "+%Y%m%d-%H%M%S")
model_name=finetune-full-base-$cur_time-bysy_lastest2-alignment
output_dir="output_model_alignment0909/$model_name"
DISTRIBUTED_ARGS="
