...
DATA1=/public/mmllm/caolili/oGVHD_model/bysy_yujing/audiodata_qwen_audio0830/bysy_yujing_desease1_train_500_r$i.jsonl # 去掉日期
DATA2=/public/mmllm/caolili/oGVHD_model/bysy_yujing/audiodata_qwen_audio0830/bysy_yujing_desease2_train_500_r$i.jsonl
DATA3=/public/mmllm/caolili/oGVHD_model/data_bysy_latest3/alignment_data7_name_noprompt0830/bysy12_qwen_train_json_sft_r$i.json # 保留了最新的

cur_time=$(date "+%Y%m%d-%H%M%S")
model_name=finetune-full-base-$cur_time-bysy-5211-r$i
output_dir="output_model_2task_0911/$model_name"
DISTRIBUTED_ARGS="
...
cd /public/mmllm/caolili/oGVHD_model/eval_med_2task_0911
...
output1=bysy_infer_json_2task_d2_r$i.jsonl
output2=bysy_infer_json_2task_d2_nospeech_r$i.jsonl
...
# # DATA='/public/mmllm/caolili/oGVHD_model/bysy_yujing/audiodata_qwen_audio_onlyaudio/bysy_yujing_desease2_train_500_r$i.jsonl'
# # DATA='/public/mmllm/caolili/oGVHD_model/bysy_yujing/audiodata/bysy_yujing_desease1_train_500_r$i.jsonl' # 不用qianwen识别出的语音
...
# cd /public/mmllm/caolili/oGVHD_model/eval_med_zd_0901
# testds=/public/mmllm/caolili/oGVHD_model/data_bysy_latest3/alignment_data7_name_noprompt0830/bysy2_qwen_test_sft_r$i.json
