...
# for i in $(seq 50 -1 21)
# do
#   echo $i
#   mv /data/caolili/oGVHD_model/output_model_2task_0913/finetune-full-base-20240919-*-bysy-5211-r$i /data/caolili/oGVHD_model/output_model_2task_0913/finetune-full-base-20240919-bysy-5211-r$i
# done
...
output_dir=/data/caolili/oGVHD_model/output_model_2task_0913/finetune-full-base-20240919-bysy-5211-r$i

cd /data/caolili/oGVHD_model/eval_med_2task_0913
