...
DATA='/public/mmllm/caolili/bysy_yujing/2200data/bysy_yujing_desease1_train_2200_r$i.jsonl' # 加上标志位的数据

cd /public/mmllm/caolili/Qwen-VL-old-bysy2
cur_time=$(date "+%Y%m%d-%H%M%S")
model_name=finetune-full-base-$cur_time-bysy_desease1_yujing2200_2211_r$i
...
testds=/public/mmllm/caolili/bysy_yujing/2200data/bysy_yujing_desease1_test_2200_r$i.jsonl
output=bysy_infer_json_yujing_decease1_$i.jsonl
