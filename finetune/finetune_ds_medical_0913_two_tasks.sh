...
DATA3=/data/caolili/oGVHD_model/data_bysy_latest3/alignment_data7_name_noprompt0830/bysy12_qwen_train_json_sft_r$i.json # 保留了最新的



cur_time=$(date "+%Y%m%d-%H%M%S")
model_name=finetune-full-base-$cur_time-bysy-5211-r$i
output_dir="output_model_2task_0913/$model_name"
DISTRIBUTED_ARGS="
