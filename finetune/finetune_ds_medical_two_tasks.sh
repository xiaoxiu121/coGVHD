...
cd /public/mmllm/caolili/Qwen-VL-old-bysy2/eval_med_2task2_5211
...
cur_time=$(date "+%Y%m%d-%H%M%S")
model_name=finetune-full-base-$cur_time-bysy-3212-r$i
output_dir="output_model_2task/$model_name"
DISTRIBUTED_ARGS="
    --nproc_per_node $GPUS_PER_NODE \
    --nnodes $NNODES \
...
cd /public/mmllm/caolili/Qwen-VL-old-bysy2/eval_med_2task2_3212
