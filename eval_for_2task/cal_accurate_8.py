...
file_list = []
# a = [2,3,5,7,8,10,11] for i in 8 19 23 26 28 29 30 31 40 46

a = [8, 19, 23, 26, 28, 29, 30, 31, 40, 46]
# for i in range(1,51):
# 最终采用的结果：noimage onlyimage

for i in a:
    # file_list.append('bysy_infer_json_20240714_latest8_nopromt_r{}.jsonl'.format(i))
    file_list.append('bysy_infer_json_20240715_latest9_noimage2_r{}.jsonl'.format(i))
    # file_list.append('bysy_infer_json_20240715_latest10_onlyimage2_r{}.jsonl'.format(i))
