...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/public/mmllm/caolili/Qwen-VL-old-bysy2/output_model/finetune-full-base-20240711-163434-bysy_lastest7-sft-2211-r1",
    )
    parser.add_argument("-f", "--sample-input-file", type=str, default='/public/mmllm/caolili/Qwen-VL-old-bysy2/data_bysy_latest2/alignment_data7/bysy2_qwen_test_sft_r1.json')
    parser.add_argument(
    ...
    for doc in test:
        ...
        value += '请根据图片信息，判断患者是否患有慢性移植物抗宿主病。'
